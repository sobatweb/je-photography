      ...
      <div className="relative z-10 bg-white rounded-[2.5rem] p-4 shadow-sm border border-gray-100 hover:shadow-2xl transition-all duration-500 flex flex-col h-full overflow-hidden">
        ...
        <div className="flex flex-col flex-1 pt-6 px-2 pb-2">
          <div className="flex items-center gap-2 mb-1">
            <h3 className="text-2xl font-bold text-[#4B2E2B] tracking-tight">{card.title}</h3>
            <CheckCircle2 size={20} className="text-green-500 fill-green-500/10" />
          </div>
          <p className="text-sm font-medium text-[#8C5A3C]/80 mb-4 italic">{card.subtitle}</p>
          <p className="text-[#4B2E2B]/60 text-sm leading-relaxed mb-8 flex-1">{card.desc}</p>
  ...
  return (
    <section id="services" className="relative py-24 md:py-32 bg-[#4B2E2B] px-6 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none select-none z-0">
        ...
        <div className="absolute top-[-5%] right-[-15%] md:right-[-10%] w-[300px] md:w-[600px] h-[300px] md:h-[600px] bg-[#8C5A3C] rounded-full blur-[80px] md:blur-[120px] opacity-30 md:opacity-20" />
        <div className="absolute bottom-[-5%] left-[-15%] md:left-[-10%] w-[250px] md:w-[500px] h-[250px] md:h-[500px] bg-[#DAC0A3] rounded-full blur-[70px] md:blur-[100px] opacity-20 md:opacity-10" />
        ...
        <div className="absolute inset-4 md:inset-10 border-white/[0.02] border-[1px] rounded-[2rem] md:rounded-[3rem]">
          <div className="absolute top-0 left-0 w-12 md:w-20 h-12 md:h-20 border-t-2 border-l-2 border-[#DAC0A3]/20 rounded-tl-2xl md:rounded-tl-3xl" />
          <div className="absolute top-0 right-0 w-12 md:w-20 h-12 md:h-20 border-t-2 border-r-2 border-[#DAC0A3]/20 rounded-tr-2xl md:rounded-tr-3xl" />
          <div className="absolute bottom-0 left-0 w-12 md:w-20 h-12 md:h-20 border-b-2 border-l-2 border-[#DAC0A3]/20 rounded-bl-2xl md:rounded-bl-3xl" />
          <div className="absolute bottom-0 right-0 w-12 md:w-20 h-12 md:h-20 border-b-2 border-r-2 border-[#DAC0A3]/20 rounded-br-2xl md:rounded-br-3xl" />
