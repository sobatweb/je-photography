      ...
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-20 xl:gap-24 items-center">
          ...
          >
            ...
            {/* Badge Pengalaman */}
            <motion.div
              className="absolute -bottom-6 -right-4 md:-right-8 bg-[#4B2E2B] text-[#FFF8F0] p-6 md:p-10 rounded-full md:rounded-[3rem] shadow-xl z-20 flex flex-col items-center justify-center aspect-square"
            ...
            <div className="absolute -top-6 -left-6 w-32 h-32 border border-[#C08552] rounded-t-[5rem] rounded-b-4xl opacity-40 -z-10"></div>
          </motion.div>
          ...
          >
            <div className="space-y-4">
              <div className="flex items-center gap-4">
                <span className="w-12 h-px bg-[#C08552]"></span>
                <span className="text-[#8C5A3C] text-xs font-bold uppercase tracking-[0.3em]">The Artist Behind The Lens</span>
              </div>
              <h2 className="text-5xl md:text-6xl xl:text-7xl font-serif text-[#4B2E2B] leading-tight">
                More Than Just <br />
                <span className="italic text-[#8C5A3C]">A Photograph.</span>
              </h2>
            </div>
            
            <div className="space-y-5 text-[#4B2E2B]/80 text-base md:text-lg leading-relaxed font-light">
              <p>
              ...
              <ul className="ml-4 border-l-2 border-[#C08552]/40 pl-5 space-y-3 py-2 text-base">
                <li><strong className="font-serif text-[#8C5A3C] font-medium text-lg tracking-wide">Je Cekrek</strong> <span className="opacity-80">— Food & Product Photography</span></li>
                <li><strong className="font-serif text-[#8C5A3C] font-medium text-lg tracking-wide">Je Petshoot</strong> <span className="opacity-80">— Pet Photography</span></li>
                <li><strong className="font-serif text-[#8C5A3C] font-medium text-lg tracking-wide">Je Carshoot</strong> <span className="opacity-80">— Automotive Photography</span></li>
                <li><strong className="font-serif text-[#8C5A3C] font-medium text-lg tracking-wide">Je Portraiture</strong> <span className="opacity-80">— Events, Portraits, & Personal Sessions</span></li>
              </ul>
              ...
              <p className="font-medium text-[#8C5A3C]">
                For inquiries and bookings, feel free to reach out via WhatsApp.
              </p>
            </div>

            {/* Statistik diubah menjadi 3 Kolom agar seimbang */}
            <div className="grid grid-cols-3 gap-4 md:gap-8 pt-8 border-t border-[#C08552]/30">
              <div>
                <p className="text-3xl lg:text-4xl font-serif text-[#4B2E2B] mb-1">4</p>
                <p className="text-[9px] md:text-[10px] uppercase tracking-widest text-[#8C5A3C] font-medium">Divisions</p>
              </div>
              <div>
                <p className="text-3xl lg:text-4xl font-serif text-[#4B2E2B] mb-1">1500+</p>
                <p className="text-[9px] md:text-[10px] uppercase tracking-widest text-[#8C5A3C] font-medium">Clients</p>
              </div>
              <div>
                <p className="text-3xl lg:text-4xl font-serif text-[#4B2E2B] mb-1">800+</p>
                <p className="text-[9px] md:text-[10px] uppercase tracking-widest text-[#8C5A3C] font-medium">Brands</p>
              </div>
            </div>
