...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#1a110a] pt-20 pb-10 px-6 relative overflow-hidden">
      <div className="container mx-auto relative z-10">
        <div className="flex flex-col lg:flex-row justify-between gap-12 mb-16">
          ...
          <div className="lg:max-w-md space-y-6 text-center lg:text-left">
            <h2 className="text-2xl md:text-2xl font-serif text-[#FFF8F0] uppercase tracking-tighter">
              Je Creative<span className="text-[#b88a44] ">.</span>
            </h2>
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center gap-3 bg-[#b88a44] text-[#1a110a] px-8 py-4 rounded-full text-[10px] font-black uppercase tracking-widest hover:bg-[#FFF8F0] hover:text-[#1a110a] transition-all shadow-lg"
            >
            ...
            <div className="grid grid-cols-2 gap-3">
              {socialLinks.map((social) => (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="group flex flex-col sm:flex-row items-center gap-3 p-4 rounded-2xl border border-[#FFF8F0]/10 bg-white/3 hover:border-[#b88a44]/40 transition-all"
                >
                  <div className="w-8 h-8 rounded-full bg-[#b88a44]/10 flex items-center justify-center text-[#b88a44] group-hover:bg-[#b88a44] group-hover:text-[#1a110a] transition-all">
                    <Instagram size={14} />
                  </div>
                  <div className="text-center sm:text-left overflow-hidden">
                    <p className="text-[12px] text-[#b88a44] uppercase font-bold">{social.name}</p>
        ...
        <div className="pt-8 border-t border-[#FFF8F0]/10 flex flex-col md:flex-row justify-between items-center gap-6 text-center">
          ...
          <button onClick={scrollToTop} className="group flex items-center gap-3 text-[#b88a44]/80 hover:text-[#FFF8F0] transition-colors">
