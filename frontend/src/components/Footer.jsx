      ...
      <div className="container mx-auto relative z-10">
        <div className="flex flex-col lg:flex-row justify-between gap-12 mb-16">
          ...
          <div className="lg:max-w-md space-y-6 text-center lg:text-left">
            <h2 className="text-5xl md:text-6xl font-serif text-[#FFF8F0] tracking-tighter">
              Jerry<span className="text-[#DAC0A3]">.</span>
            </h2>
            <p className="text-[#FFF8F0]/60 font-light leading-relaxed text-sm max-w-sm mx-auto lg:mx-0">
              Menangkap esensi unik dari setiap subjek, mulai dari otomotif hingga hewan peliharaan. Setiap jepretan adalah cerita yang abadi.
            </p>
            <a 
            ...
            >
              <MessageCircle size={16} fill="currentColor" /> Chat WhatsApp
            </a>
          </div>

          {/* Instagram Grid - 2 Kolom di Mobile */}
            ...
            <div className="grid grid-cols-2 gap-3">
              {socialLinks.map((social) => (
                <a 
                  ...
                  target="_blank" 
                  rel="noreferrer"
                  className="group flex flex-col sm:flex-row items-center gap-3 p-4 rounded-2xl border border-[#FFF8F0]/10 bg-white/[0.03] hover:border-[#DAC0A3]/40 transition-all"
                >
        ...
        <div className="pt-8 border-t border-[#FFF8F0]/10 flex flex-col md:flex-row justify-between items-center gap-6 text-center">
          <p className="text-[8px] uppercase tracking-[0.3em] text-[#FFF8F0]/50">
            © 2026 JERRY PORTFOLIO — VISUAL EXCELLENCE.
          </p>
